 ...
 */
final class Version20220128142027 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE word (id INT AUTO_INCREMENT NOT NULL, lexicon_id INT DEFAULT NULL, filename VARCHAR(255) NOT NULL, definition LONGTEXT DEFAULT NULL, img VARCHAR(255) DEFAULT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_C3F1751188C5CA0A (lexicon_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
